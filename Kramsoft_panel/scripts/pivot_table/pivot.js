    ...
    */
    ...
    $.fn.pivotUI = function (input, inputOpts, overwrite, locale) {
        ...
        try {
            ...
            uiTable = $("<table cellpadding='5' class='table-ui'>");
            rendererControl = $("<td>");
            renderer = $("<select class='pvtRenderer pvtAggregator'>").appendTo(rendererControl).bind("change", function () {
                return refresh();
            });
            ...
            _fn = function (c) {
                ...
                if (keys.length > opts.menuLimit) {
                    ...
                    btns = $("<p class='filter-action'>").appendTo(valueList);
                    btns.append($("<button class='btn file-button'>").html(opts.localeStrings.selectAll).bind("click", function () {
                        return valueList.find("input:visible").prop("checked", true);
                    }));
                    btns.append($("<button class='btn file-button'>").html(opts.localeStrings.selectNone).bind("click", function () {
                        return valueList.find("input:visible").prop("checked", false);
                    }));
                    btns.append($("<input class='pvtAggregator'>").addClass("pvtSearch").attr("placeholder", opts.localeStrings.filterResults).bind("keyup", function () {
                        var filter;
                ...
                $("<p class='filter-bottom'>").appendTo(valueList).append($("<button class='btn wizard-button-refresh btn-block'>").text("OK").bind("click", updateFilter));
                showFilterList = function (e) {
                    ...
                    if ($(".page-header-fixed-top").length > 0) {
                        e.pageY = e.pageY - 90;
                ...
                return function () {
                    ...
                    if (numInputsToProcess !== 0) {
                        ...
                        for (x = _m = 0; 0 <= numInputsToProcess ? _m < numInputsToProcess : _m > numInputsToProcess; x = 0 <= numInputsToProcess ? ++_m : --_m) {
                            newDropdown = $("<select class='pvtAttrDropdown pvtAggregator'>").append($("<option>")).bind("change", function () {
                                return refresh();
                            });
